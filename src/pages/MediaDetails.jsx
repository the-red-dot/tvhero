...
function MediaDetails() {
  ...
  async function fetchVideoStreams(title, season = null, episode = null) {
    try {
      let url = `https://ba78-2a10-8012-d-79ff-3168-911a-19d0-57e0.ngrok-free.app/fetch_stream?title=${encodeURIComponent(title)}`;
      ...
      const response = await fetch(url, {
        headers: {
          ...
          'Referer': 'https://ba78-2a10-8012-d-79ff-3168-911a-19d0-57e0.ngrok-free.app'
        }
      });
